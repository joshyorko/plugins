...
| New web UI automation | `RPA.Browser.Playwright` | RCC-managed `rpaframework`, `robotframework-browser`, required Node.js runtime, and project engines installed with `rfbrowser init` | Selenium only for maintained Selenium suites or required capability | [Browser Playwright](https://rpaframework.org/libraries/browser_playwright/index.html), [Robot Framework Browser installation](https://marketsquare.github.io/robotframework-browser/Browser.html#Installation) |
